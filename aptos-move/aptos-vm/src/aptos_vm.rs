...
use aptos_types::{
    ...
    transaction::{
        ...
        AuxiliaryInfo, BlockOutput, EntryFunction, ExecutionError, ExecutionStatus, ModuleBundle, PersistedAuxiliaryInfo,
...
use move_vm_runtime::{
    ...
    ScriptLoader, WithRuntimeEnvironment, LoadedFunctionOwner
};
...
impl AptosVM {
    ...
    pub fn get_call_trace(
        ...
        let txn_metadata = TransactionMetadata::new(txn, &auxiliary_info, vm.timed_features());
    ...
    pub fn get_call_trace_for_entry_function(
